...
import home from 'assets/sobre/casa.png';
...
export default function About() {
  return (
    <section>
      <h3 className={stylesTheme.title}></h3>
      <div className={styles.aboutUs}>
        ...
        <div className={styles.aboutUs__text}>
          <p>
            ...
            sofisticada de São Paulo! Prezamos pelos ingredientes tradicionais da culinária Italiana, frescos e de
